...
- Консоль управления
   ...
   **Создать YDB-таблицу**
   ...
   2. Справа выберите пункт "Навигация"
   3. Выберите **Создать** → **Таблица** в правой части страницы. (На месте синей кнопки SQL-запрос)
   ...
   6. При необходимости настройте [вторичные индексы](../concepts/secondary_indexes.md):
